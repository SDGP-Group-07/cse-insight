      ...
      <main className="flex-grow">
        ...
        <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
          ...
          <div className="hidden lg:flex absolute left-8 top-1/2 -translate-y-1/2 flex-col gap-6 z-30">
            <a
              href="https://facebook.com/cseinsight"
              target="_blank"
            ...
            <a
              href="https://twitter.com/cseinsight"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-accent-cyan transition-colors transform hover:scale-110"
            >
            ...
            <a
              href="https://linkedin.com/company/cseinsight"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-accent-cyan transition-colors transform hover:scale-110"
            >
            ...
            <a
              href="https://youtube.com/cseinsight"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-accent-cyan transition-colors transform hover:scale-110"
            >
          ...
          <div className="container mx-auto px-6 relative z-20 text-center max-w-4xl">
            ...
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-100">
              Learn the market. Read the signals. Invest with confidence.
            </p>
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <Button
                    type="submit"
                    variant="primary"
                    className="px-6 py-3 group whitespace-nowrap"
                  >
                    Join Waitlist
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-400 leading-relaxed">
                  We are a team of five student developers who started as
                  complete beginners in the world of investing. Like many new
                  investors, we struggled to understand how the Colombo Stock
                  Exchange works, the jargon, the reports, the trends, the
                  risks. That shared experience and curiosity brought us
                  together.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Our challenges inspired a mission: to build a simple,
                  accessible platform that helps others learn the CSE the way we
                  wish we had experienced it. Through CSE Insight, we aim to
                  make investing clearer, less intimidating, and more
                  understandable for everyone, especially beginners taking their
                  first step.
                </p>
              </div>
            </div>
